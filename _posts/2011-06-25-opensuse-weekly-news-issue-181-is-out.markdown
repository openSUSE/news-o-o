...
The Kernel Log is taking the development progress of Linux 3.0 as an opportunity to
            ...
            of filesystems. Partý1 of the mini-series discussed the changes to the [network drivers and infrastructure](http://www.h-online.com/open/features/Kernel-Log-Coming-in-3-0-Part-1-Networking-1257847.html); over the coming weeks, further articles
