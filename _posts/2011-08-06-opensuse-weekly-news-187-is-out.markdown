...
The Articles inside this Section are in full. If you are already knowing the stuff in
      ...
      [Volunteers
        needed for the conference](https://news.opensuse.org/2011/08/01/volunteers-needed-conference/)
...
As you know, the third internationalÂ [openSUSE
      ...
      hands. We especially missÂ boots on the ground,Â **we need your help!**
...
[Are you ready for RWXÂ³
        ?](https://news.opensuse.org/2011/08/01/are-you-ready/)
...
If you want to come, but money is a problem then you can apply for assistance through
        theÂ [Conference travel sponsorship program](https://news.opensuse.org/2011/08/01/2011/07/23/travel-sponsorship-program/). People of openSUSE ˜are willing to help you,
      as much as possible.
...
[David Williams: Entomologist UI Changes “ Weekly reportÂ #11](http://redache.wordpress.com/2011/08/06/entomologist-ui-changes-weekly-report-11/)
...
So far, the new kontact 2.0 version has not been submitted for Factory and you can get
        ...
        you™re running already kmail2 and like to switch follow[Ismail™s advice](http://lists.opensuse.org/opensuse-kde/2011-07/msg00268.html)Â to change in ~/.config/akonadi/akonadiserverrc the line Driver=QMYSQL to
        Driver=QSQLITE.
...
[Jos
          Poortvlieet: And they keep rocking¦](https://news.opensuse.org/2011/08/04/and-they-keep-rocking%E2%80%A6/)

Over the last few months the openSUSE ambassadors have continued to visit conferences
      around the world. Since ourÂ [previous report](https://news.opensuse.org/2011/05/06/opensuse-ambassadors-are-rocking-all-over-the-world/)Â beginning of May, several big events have happened and we™ll treat
...
Let™s start with a few quick links to reports which are already online and probably read
      by some of you. There is for example the huge splash Greece ambassadors made atÂ [Fosscomm 2011](https://news.opensuse.org/2011/05/27/fosscomm-2011/)Â which took
...
The Greek team also organized aÂ [summer
      camp](https://news.opensuse.org/2011/06/20/opensuse-summer-camp-greece-2011/)Â from which you can see pictures in theirÂ [facebook group](http://www.facebook.com/group.php?gid=153638841330360). Rest
      assured we™ll make them work harder after they so clearly spend a lot of time drinking and
      hanging in the sun¦

Most interestingly, the Greek team went toÂ [the Xariseto.gr bazaar](http://zoumpis.wordpress.com/2011/05/20/participation-of-opensuse-greek-community-in-xariseto-gr-bazaar-may-14-2011-report/). In Thanasis™ words: Xariseto is a festival where people
...
At the end of April, Ricardo Varas Santana attended the FLISoL event in Chile, which has
      about 1000 visitors. He gave a talk titledÂ openSUSE, Linux in Green
...
Take the incredible Baltasar Ortega who has been covering openSUSE and KDE
      ...
      Spanish, be sure to bookmark his blog. He will point you to[gems like the
        Studio Imagewriter](http://www.kdeblog.com/como-grabar-tu-live-usb-con-imagewriter.html)Â or shareÂ [wonderful tutorials like these](http://www.kdeblog.com/kde-tutorials-7-y-8-cambiando-las-fuentes-y-uso-basico-de-dolphin.html). Max wrote an article aboutÂ openSUSE and HadoopÂ the May edition of the Hongkong Chinese/TaiwaneseÂ [Linux Pilot Magazine](http://www.linuxpilot.com/issue/102).

And did you notice our Greek teamÂ [translates the awesome Weekly News in Greece](http://opensuseambassadors.blogspot.com/2011/07/greek-opensuse-community-translation-of_15.html)?
...
The work these ambassadors do for openSUSE is incredibly valuable and should not be under
      ...
      event, remarkingÂ [in his
        interview](https://news.opensuse.org/2011/06/23/people-of-opensuse-christos-bountalis/), when asked why he joined openSUSE: I have found many nice and interesting
...
So we™d like to thank our ambassadors for their awesome work, and invite anyone toÂ [join their ranks](http://en.opensuse.org/openSUSE:Ambassadors)!
...
### From Ambassadors
        ...
        [1st Greek openSUSE Collaboration Summer weekend Camp: The Report](https://news.opensuse.org/2011/08/03/1st-greek-opensuse-collaboration-camp-the-report/)
...
After a dinner break from 19:30 to 20:30 there was a Translation contest. The original
        ...
        one and a half hour total but everybody asked for more time to do more work, soÂ Â Â [Diomidis Anadiotis](http://anadiotisd.wordpress.com/)Â talk ˜I am new to the
...
At Saturday there was an early wake around 8:30 for breakfast and around 10:15 the program
        started with the announcement of the previous night™s contest whereÂ [Diomidis Anadiotis](http://anadiotisd.wordpress.com/)Â won the Geeko plush
        reward. The First presentation of the day was ˜Using Yast “ System management: easy, fast and
        with many options™ where Efstatios Agrapidis andÂ [Kostas Koudaras](http://e-tote-kala.blogspot.com/)Â presented how and why to use YaST more.Â Â Â  The day continued
        ...
        making a tutorial of how and why to use it. After that[Stavros Kalapothas](http://www.itsystem.gr/)Â andÂ [Efstathios Hatzikiriakidis](http://efxa.org/)Â from[The-Hackerspace](http://the-hackerspace.org/)Â presented ˜Security and arduino: Multifactor authentication system
...
At around 17:30 the program started again with ˜Qt Signals And Slots™ from Antonis
        ...
        workshop from the people ofÂ [The-Hackerspace](http://the-hackerspace.org/)Â titled ˜Security and arduino: Wireless devices remote control (client
        “ server control center)™. There was a dinner break and then continued with a ˜Vim
        introduction™ byÂ [Yannis Chatzimichos](http://y.chatz.gr/blog)Â which was
...
Sunday was the last day and it started around 10:00 after breakfast with the Gnome
        community and[Efstathios Iosifidis](http://stathisuse.blogspot.com/)Â presenting ˜Surviving with Gnome 3 in a KDE-world™. Efstathios Agrapidis
        ...
        Frameworks™ and how to work with them. The day finished with a talk fromÂ [Athanasios-Ilias Rousinopoulos](http://zoumpis.wordpress.com/)Â titled ˜openSUSE
...
Most important, all participants are impatiently looking forward to the next event! Soon
        the videos of the workshops and talks will be available atÂ [YouTube](http://www.youtube.com/user/opensusetv), stay tuned¦
...
Please refer to myÂ [previous
  ...
  * There™s no full changelog about them, butÂ [Catalyst 11.7 installer](http://www2.ati.com/relnotes/Catalyst_11.7_Linux_Installer.pdf)Â (pdf)
...
openSUSE Weekly News is translated into many languages. Issue 187 is available in: 
  ...
  * [English](https://news.opensuse.org/?p=9948)
