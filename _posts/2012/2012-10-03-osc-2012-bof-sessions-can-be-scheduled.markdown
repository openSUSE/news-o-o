...
So go to the [BoF wiki page](//en.opensuse.org/openSUSE:Conference_BoF_sessions) and add a BoF! You've got until the day before the conference to do this - after that, we'll schedule at the event itself using whiteboards.
