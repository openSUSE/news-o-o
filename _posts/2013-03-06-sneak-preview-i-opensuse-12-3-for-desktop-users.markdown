...
({{ site.baseurl }}/assets/Screenshot-from-2013-03-06-204014.png) The default GNOME Shell
...
({{ site.baseurl }}/assets/Favorite-extensions.png) Shell with Extensions
...
({{ site.baseurl }}/assets/clean-interfaces-in-GNOME.png) clean interfaces in GNOME
...
({{ site.baseurl }}/assets/Applications.png) GNOME Applications
...
({{ site.baseurl }}/assets/stock-GNOME.png) Thoughtful Empathy lets you take a snap
...
({{ site.baseurl }}/assets/LibreOffice_12.31.png) LibreOffice in GNOME Shell
...
({{ site.baseurl }}/assets/Documents_12.3.png) GNOME Documents
...
({{ site.baseurl }}/assets/12.3_Widgets.png) Plasma Desktop Widgets
...
({{ site.baseurl }}/assets/KDE-wifi-dialoge.png) Wifi is more complicated
...
({{ site.baseurl }}/assets/KDE-Notifications.png) Notifications
...
({{ site.baseurl }}/assets/KDE-menu-search.png) Searching in both menu options
...
({{ site.baseurl }}/assets/KDE-Dolphin-Services.png) Configuring Services
...
({{ site.baseurl }}/assets/KDE-showfoto.png) Showfoto awesomeness
...
({{ site.baseurl }}/assets/Plasma-Netbook.png) The netbook Search and Launch
