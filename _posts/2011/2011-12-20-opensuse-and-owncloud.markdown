...
[![ownCloud logo](/wp-content/uploads/2011/11/owncloud-logo.png)](//news.opensuse.org/2011/12/20/opensuse-and-owncloud/owncloud-logo-2/)
...
[![Credit to XKCD for the great joke :D](/wp-content/uploads/2011/11/the_cloud.png)](//news.opensuse.org/2011/12/20/opensuse-and-owncloud/the_cloud/)
...
Just a week ago, Frank [announced the start of ownCloud Inc.](//blog.karlitschek.de/2011/12/owncloud-inc-and-owncloud-community.html) which "will help _[the ownCloud team]_ to spread ownCloud and free cloud services in general – way more than we could have done without". This will bring additional resources to ownCloud development, making it the most promising Free Software solution for protecting your Freedom in the cloud!
...
[caption id="attachment_11866" align="alignright" width="300" caption="ownCloud and GNOME Calendar"][![](/wp-content/uploads/2011/11/owncloud2.png)](//news.opensuse.org/2011/12/20/opensuse-and-owncloud/owncloud2-2/)[/caption]
...
[![Click to install mirall](/wp-content/uploads/2011/11/Oneclick.png)](//software.opensuse.org/ymp/openSUSE:12.1:Update:Test/standard/mirall.ymp?base=openSUSE%3A12.1&query=mirall)
...
[![creating a new ownCloud](/wp-content/uploads/2011/11/creating-a-new-ownCloud.png)](//news.opensuse.org/2011/12/20/opensuse-and-owncloud/creating-a-new-owncloud/)
...
These functions are working with mirall today. More functionality will be implemented following the described vision and based on user feedback. Of course, patches are welcome! You can [contact Klaas directly](//en.opensuse.org/User:Kfreitag) or [talk to the ownCloud team](//owncloud.org/contact/).
...
For users of openSUSE 11.4 and older, you can find more (and up-to-date) instructions on getting ownCloud and mirall installed on the [openSUSE wiki](//en.opensuse.org/SDB:OwnCloud).
...
[![New oc connect.png](//en.opensuse.org/images/b/bb/New_oc_connect.png)](//en.opensuse.org/File:New_oc_connect.png)
...
If you choose to _create a new ownCloud_ on the first dialog page, the next wizard page asks you if you want to create it on the local computer or on an internet domain you control. In both cases Mirall downloads latest stable sources of ownCloud from the [ownCloud project page](//owncloud.org/), extracts it on the local machine and copies it to the target system.
...
[![choose an express folder](/wp-content/uploads/2011/11/choose-an-express-folder-2.png)](//news.opensuse.org/2011/12/20/opensuse-and-owncloud/choose-an-express-folder-2/)
...
[![Statusdialog.png](//en.opensuse.org/images/c/cc/Statusdialog.png)](//en.opensuse.org/File:Statusdialog.png)
...
The latest information about mirall usage and features can be found on the [openSUSE wiki](//en.opensuse.org/Mirall) and especially the [Support Database article for ownCloud and mirall](//en.opensuse.org/SDB:OwnCloud).
