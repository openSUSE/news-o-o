...
[Andreas Jaeger: openSUSE Release versioning – Poll on last three options](//lizards.opensuse.org/2011/03/28/opensuse-release-versioning-poll-on-last-three-options/)

The poll on SurveyMonkey on how to version the openSUSE distribution release is now
      closed, you can see the results [here](//www.surveymonkey.com/sr.aspx?sm=ZMyUjEimqUeLGFeX8Kmq_2baNaoqX9TRhoTN0KA_2fPlQxQ_3d). The winner is the “old school” (like currently but only counting the right
...
[Review – openSUSE 11.4 and the much improved XFCE 4.8](//news.opensuse.org/2011/03/28/review-opensuse-11-4-and-the-much-improved-xfce-4-8/)

Just a few months ago, the XFCE project announcedý[XFCE 4.8](//www.xfce.org/about/news/?post=1295136000),ýthe result of over 2
      years of hard work. This desktop, one of the four official desktops of [openSUSE 11.4](//news.opensuse.org/2011/03/10/opensuse-11-4/), brings many
...
To test XFCE Figure 1, “The default XFCE desktop” I went into [SUSE Studio](//susestudio.com) and
...
[A year of Collaboration ahead](//news.opensuse.org/2011/03/25/linux-foundation-//news.opensuse.org/2011/03/30/a-year-of-collaboration-ahead)

The openSUSE Project considers collaboration an important value for a Free Software
      community. After our [successful
        openSUSE conference](//news.opensuse.org/2010/10/28/opensuse-conference-big-success/) which had a strong focus on collaboration, several cool things
      have started. Now it is time for **[openSUSE bring collaboration to the Google
          Summer of Code](//en.opensuse.org/openSUSE:GSOC_2011)** and we invite students to join us in making Free
      ...
      Code is a project by Google to [let
        students spend their summer time on coding instead of a waiting tables.](//en.opensuse.org/openSUSE:Why_GSOC)
...
[Michal Hrusecky: GSoC 2011 Ideas – Karma plugin for openSUSE Connect](//michal.hrusecky.net/2011/03/gsoc-2011-ideas-karma-plugin-for-opensuse-connect/)

This post is about one idea for GSoC 2011 regarding openSUSE Connect. I already [wrote about
        it](//michal.hrusecky.net/2010/08/ideas-about-karma-in-opensuse-connect/) some time ago, but now is time to elaborate a little bit more.
...
So there is a lot of work to do and student who applied has even some more ideas, so I
      think if this project will get selected, openSUSE Connect will be much more fun ![](//michal.hrusecky.net/wp-includes/images/smilies/icon_wink.gif)
...
[Kai-Uwe Behrmann: Google Summer of Code 2011 Student Applications open](//oyranos-cms.blogspot.com/2011/03/google-summer-of-code-2011-student.html)

This years [Google Summer of Code](//www.google-melange.com/)
      program is open for student proposals. [OpenICC](//freedesktop.org/wiki/OpenIcc/GoogleSoC2011) in collaboration
      with openPrinting and [openSUSE](//en.opensuse.org/openSUSE:GSOC_2011_Ideas#ICC_Device_Profile_Repository) provide mentored projects around colour management. Own ideas from female
...
[SUSE Studio](//susestudio.com) is an awesome tool, with a couple
...
You can save some time by cloning [this](//susegallery.com/a/CZ0T0D/rails-in-a-box) appliance shared on
          [SUSE Gallery](//susegallery.com/), but this is still going to be
        boring. (...)

**License**: [CC-BY-NC-SA](//creativecommons.org/licenses/by-nc-sa/2.5/it/)
...
I’m happy to announce LibreOffice 3.3.2 bugfix release for openSUSE. The packages are
          ...
          translation problems, see the [libreoffice-3.3.2.2 release news](//cgit.freedesktop.org/libreoffice/build/plain/NEWS?id=libreoffice-3.3.2.2) for more details. See also some notes about
            [openSUSE LibreOffice build](//en.opensuse.org/LibreOffice).
...
Further information is available at [//en.opensuse.org/openSUSE:Open-Bugs-Day](//en.opensuse.org/openSUSE:Open-Bugs-Day).
...
[Pavol
          Rusnak: openSUSE 11.4 Release Party – Prague](//stick.gk2.sk/blog/2011/03/opensuse-11-4-release-party-prague/)

Last Friday we held an [openSUSE 11.4 Release Party](//brmlab.cz/event/opensuse_11.4_release_party) in Prague, more particularly in the first Czech
        hackerspace called [brmlab](//brmlab.cz/). We decided to go with
        later date and not doing the party immediately after the release, so we could have promo
        materials available. This included openSUSE posters, DVD media, T-shirts but alsoý[openSUSE beer](//wiki.opensuse.org/openSUSE:Beer)! Thanks [Michal](//michal.hrusecky.net/) and [Klaas](//lizards.opensuse.org/author/kfreitag/) for delivering them to
...
**License**: [CC-BY-NC-SA](//creativecommons.org/licenses/by-nc-nd/3.0/)
...
[This Week: Petr Mladek](//sysbytes.wordpress.com/2011/03/07/an-interview-with-petr-mladek-libre-office-developer/)
...
[Packman: LiVES
      1.4.2](//packman.links2linux.org/package/LiVES)
...
[Packman: youtube-dl
        20110329-1](//packman.links2linux.org/package/youtube-dl/220571)
...
[Holger Hetterich: SMB Traffic Analyzer bug tracking moving from BNC to BSO](//holger123.wordpress.com/2011/03/29/smb-traffic-analyzer-bug-tracking-moving-from-bnc-to-bso/)

Hello reader, this article is about the **SMB Traffic Analyzer
        project**, more info is [here](//holger123.wordpress.com/smb-traffic-analyzer/).

Today, we are moving **the full release- and bug tracking**
      from [bugzilla.novell.com](//bugzilla.novell.com) to [bugzilla.samba.org](//bugzilla.samba.org).

Thanks to the **bugzilla maintainers at [the Samba Team](//www.samba.org/samba/team/)**, SMBTA gained
...
[Packman: DVDStyler
        1.8.2.1](//packman.links2linux.org/package/DVDStyler)
...
[Packman: kmediafactory
        0.8.0](//packman.links2linux.org/package/gmerlin)
...
[h-online/Thorsten Leemhuis: Kernel Log: First release candidate for Linux
      2.6.39](//www.h-online.com/open/features/Kernel-Log-First-release-candidate-for-Linux-2-6-39-1218465.html)
...
Fifteen days after [releasing Linux 2.6.38](//www.h-online.com/open/features/What-s-new-in-Linux-2-6-38-1205467.html), Linus Torvalds has closed the merge window of Linux 2.6.39,
      and completed the integration of this version's major changes, by [issuing 2.6.39-rc1](//thread.gmane.org/gmane.linux.kernel/1119897). At the
...
[Rares Aioanei: kernel weekly news – 02.04.2011](//schaiba.wordpress.com/2011/04/02/kernle-weekly-news-02-04-2011/)
...
![](//cdn.unixmen.com/images/stories/thumbnails/images-stories-videos-aljazeera1-400x225.png)
...
If you want to read some more about this topic, I suggest to have a look at:
  ...
  * [Wikipedia](//en.wikipedia.org/wiki/Sequence_point)

  * [//publications.gbdirect.co.uk/c_book/chapter8/sequence_points.html](//publications.gbdirect.co.uk/c_book/chapter8/sequence_points.html)
...
[Kohei Yoshida: mdds 0.5.2
        released](//kohei.us/2011/03/28/mdds-0-5-2-released/)
...
[//multidimalgorithm.googlecode.com/files/mdds_0.5.2.tar.bz2](//multidimalgorithm.googlecode.com/files/mdds_0.5.2.tar.bz2)
...
[Kai-Uwe Behrmann: Libre Graphics Meeting 2011 Montreal](//oyranos-cms.blogspot.com/2011/03/libre-graphics-meeting-2011-montreal.html)

[LGM](//www.libregraphicsmeeting.org/) will this year happen in
...
[Nelson
        Marques: GNOME:Ayatana – being populated](//lizards.opensuse.org/2011/03/30/gnomeayatana-being-populated/)
...
[Introducing
        snapper: A tool for managing btrfs snapshots](//lizards.opensuse.org/2011/04/01/introducing-snapper/)
...
[Opensociety:
          ODF 1.2 approved as Committee Specification](//www.opendocsociety.org/news/odf-tc-approves-odf-1.2)

The OASIS Open Document Format for Office Applications (OpenDocument) TC has officially
        and unanimously [approved](//lists.oasis-open.org/archives/office/201103/msg00089.html)
...
OpenDoc Society congratulates the members of the ODF TC on their work. “This is an
          important step for the entire ecosystem”, states Michiel Leenaars, board member of
        OpenDoc Society, “There is significant demand for this new version of the standard, as
          ...
          interoperability for office applications is finally there”. With already very
...
[Computerworld/Katherine Noyes: 10 ways that Linux is making life better](//www.computerworld.com/s/article/9215252/10_ways_that_Linux_is_making_life_better)

Linux has long played a leading role [in the world of servers](//www.pcworld.com/businesscenter/article/204423/five_reasons_linux_beats_windows_for_servers.html), due in large part to its stability, security and lower
...
Not only are distributions like [Ubuntu](//www.pcworld.com/businesscenter/article/221517/work_begins_on_ubuntu_1110_oneiric_ocelot.html) helping Linux make great strides [on the desktop](//www.pcworld.com/businesscenter/article/208111/reports_of_linuxs_desktop_death_are_premature.html), but the open-source operating system is now quietly powering
...
[Mario Fux: We need you for Nepomuk
          (integration)!](//blogs.fsfe.org/mario/?p=130)
...
First I’d like to thank David Vignoni for his work on the logo for the Randa meeting.
        It’s the basis for the work of the [young
          informatic trainees](//blogs.fsfe.org/mario/?p=121). But the results are still secret (as even I haven’t seen
        anything myself but get the first results at the end of this week ![](//blogs.fsfe.org/mario/wp-includes/images/smilies/icon_wink.gif) .

And now to the ideas and proposals (btw this has nothing in common with the [GSoC ideas of KDE](//community.kde.org/GSoC/2011/Ideas)!). As you
        probably or hopefully already know the [KDE Nepomuk
          team](//nepomuk.kde.org) will have a meeting in [Randa](//community.kde.org/Sprints/Randa) this June (from the 1st to the 7th of this month) and we still want
        application developers to integrate this technology in their application or to work on some
        interesting and great new ideas. And there will be really good help as [Sebastian Trýg](//trueg.wordpress.com/) will be in Randa and he is going
  ...
  * The KDE semantic clipboard. There is [some
              code](//websvn.kde.org/trunk/playground/base/nepomuk-kde/semclip/) in the old subversion playground of KDE and in December 2010 I wrote a
              [paper](//blogs.fsfe.org/mario/thesis_template.pdf) about this
  ...
  * All of the new [KDE PIM](//community.kde.org/KDE_PIM)
            application use Nepomuk technology through their [Akonadi](//community.kde.org/KDE_PIM/Akonadi) interactions.

  * [Digikam](//www.digikam.org) had (or has?) some capabilities
            to exchange its information and metadata with the Nepomuk storage. What about tagging
            your pictures with the contacts (and [PIMO::Persons](//www.semanticdesktop.org/ontologies/pimo/)) of the
            new Kaddressbook and projects which are then usable system wide.

  * And [Amarok](//amarok.kde.org) had (or again has?) some
  ...
  * But there are as well good examples for existing Nepomuk integration: [Bangarang](//bangarangkde.wordpress.com/). A multimedia player which
  ...
  * Another idea could be a (scientific) paper or article collector which understands
            ...
            actually links and thus relations to other papers and articles. Take a look at the
              [SWRC ontology](//ontoware.org/swrc/).

  * Yet another project which extensively uses Nepomuk is the new [KDE Telepathy
              framework](//community.kde.org/Real-Time_Communication_and_Collaboration). They don’t just invent yet another represenation of a person and
            its contacts but use PIMO::Person and thus make connections to them system wide
            comprehensible and reusable.

  * And let’s not forget the [Plasma framework](//plasma.kde.org)
            and its [activities](//userbase.kde.org/Plasma#Activities). But
            there is more and better information about this on the [site of ivan Cukic](//ivan.fomentgroup.org/blog/).

  * Or something completely new. An ontology for TV series, recordings and shows…
            (Update: Sebastian told me that there is already one: [NMM](//sourceforge.net/apps/trac/oscaf/ticket/44). And Bangarang and
            some other applications use it.)

  * And there is [Zeitgeist](//zeitgeist-project.com/) and [QtZeitgeist](//releases.zeitgeist-project.com/qzeitgeist/)…
            (...)
...
[h-online: openSUSE 11.4 Edu Li-f-e released](//www.h-online.com/open/news/item/openSUSE-11-4-Edu-Li-f-e-released-1217365.html)

Just over two weeks after the release of openSUSE 11.4, the [openSUSE Education](//en.opensuse.org/Education) development team has
...
[Unixmen/M. Zinoune
          (Zinovsky): OpenSUSE Edu Li-f-e 11.4 for education is released!](//www.unixmen.com/software/1601-opensuse-edu-li-f-e-114-for-education-is-released)

[OpenSUSE Edu Li-f-e 11.4 ](//news.opensuse.org/2011/03/29/opensuse-edu-li-f-e-11-4-out-now/)for education is released. Based on [openSUSE 11.4](//www.unixmen.com/linux-tutorials/linux-distributions/suse/1558-opensuse-114-is-released-with-screenshots-tour),“this release includes the latest carefully selected software
...
[YouTube Video: openSUSE Li-f-e
          Overview](//www.youtube.com/v/O-xU1ldUoeM)

More information can be found on the[ release
          announcement](//news.opensuse.org/2011/03/29/opensuse-edu-li-f-e-11-4-out-now/).

If you are using a previous release of Opensuse Edu and you want to upgrade to this new
        release, please [check out previous post](//www.unixmen.com/linux-tutorials/documentations-a-howto/1578-upgrade-opensuse-to-114).

[openSUSE Edu: Li-f-e applications
          (Video)](//www.youtube.com/v/6NWg8I2N_6U)
...
[Frederik Schwarzer: German subforum on forum.kde.org opens its gates](//looksblo.wordpress.com/2011/03/30/german-subforum-on-forum-kde-org-opens-its-gates/)

A few minutes ago, a subforum was created on [forum.kde.org](//forum.kde.org/) for all the German-speaking users out there (and yes, developers
...
On your mouse, get ready, [Go!](//forum.kde.org/viewforum.php?f=204)

”

“

[h-online: Linux distributions to include /run/ directory](//www.h-online.com/open/news/item/Linux-distributions-to-include-run-directory-1219006.html)

On the Fedora project's developer list, systemd developer Lennart Poettering has [announced](//thread.gmane.org/gmane.linux.redhat.fedora.devel/146976) the
...
[FOSDEM 2011: LibreOffice Online Help (Wikihelp)](//artax.karlin.mff.cuni.cz/~kendy/blog/archives/monthly/2011-03.html#2011-03-31T11_35_21.htm)
...
[LibreOffice Online Help (Wikihelp)](//artax.karlin.mff.cuni.cz/%7Ekendy/blog/pics/LibreOffice-wikihelp-FOSDEM2011.odp)

It talks briefly about what we have done to bring the [LibreOffice help](//help.libreoffice.org) online, and about the future
...
[Convert LibreOffice Help to Platform Specific Help Files](//wiki.documentfoundation.org/Development/Gsoc/Ideas#Convert_the_LibreOffice_web_help_.28wikihelp.29_to_platform_specific_help_files)
...
[Linux.com/Nathan Willis: Weekend Project: Create a Paperless Linux Office](//www.linux.com/learn/tutorials/426566:weekend-project-create-a-paperless-linux-office)
...
Clearly, you could just scan everything and save your documents as TIFF or JPEG files.
        ...
        and those with sheet-feeders or other attachments) thanks to the [SANE](//www.sane-project.org/) project. There is also no shortage of
        quality scan applications, like [Kooka](//kooka.kde.org/), [XSane](//www.xsane.org/), or [Simple Scan](https://launchpad.net/simple-scan). But with images alone you
...
Do you have comments on any of the things mentioned in this article? Then head right over to
    the [comment section](//news.opensuse.org/?p=8063) and let us know! 
