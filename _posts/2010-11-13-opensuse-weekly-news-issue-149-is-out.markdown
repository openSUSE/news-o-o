...
## In the issue 149 you can read
  ...
  * [ openSUSE News: openSUSE Announces Third Development Milestone Evaluating systemd](https://news.opensuse.org/?p=5480#openSUSE_News:_openSUSE_Announces_Third_Development_Milestone_Evaluating_systemd)


  * [ Sascha Manns: openSUSE medical team releases stable version 0.0.6](https://news.opensuse.org/?p=5480#Sascha_Manns:_openSUSE_medical_team_releases_stable_version_0.0.6)


  * [ Sirko Kemter: openSUSE A-Z Guide at BLIT 2010](https://news.opensuse.org/?p=5480#Sirko_Kemter:_openSUSE_A-Z_Guide_at_BLIT_2010)


  * [ Sankar P: Detecting Memory Leaks in Kernel](https://news.opensuse.org/?p=5480#Sankar_P:_Detecting_Memory_Leaks_in_Kernel)


  * [ Michael Löffler: /me is leaving](https://news.opensuse.org/?p=5480#Michael_L.C3.B6ffler:_.2Fme_is_leaving)
...
**Content:**
  ...
  * [ Announcements](https://news.opensuse.org/?p=5480#Announcements)


  * [ Status Updates](https://news.opensuse.org/?p=5480#Status_Updates)


  * [ Team Reports](https://news.opensuse.org/?p=5480#Team_Reports)


  * [ In the Community](https://news.opensuse.org/?p=5480#In_the_Community)


  * [ New Applications](https://news.opensuse.org/?p=5480#New.2FUpdated_Applications_.40_openSUSE)


  * [ Security Updates](https://news.opensuse.org/?p=5480#Security_Updates)


  * [ Kernel Review](https://news.opensuse.org/?p=5480#Kernel_Review)


  * [ Tips and Tricks](https://news.opensuse.org/?p=5480#Tips_and_Tricks)


  * [ Planet SUSE](https://news.opensuse.org/?p=5480#Planet_SUSE)


  * [ openSUSE Forums](https://news.opensuse.org/?p=5480#openSUSE_Forums)


  * [ On the Web](https://news.opensuse.org/?p=5480#On_the_Web)


  * [ Contact us](https://news.opensuse.org/?p=5480#Feedback_.2F_Communicate_.2F_Get_Involved)


  * [ Credits](https://news.opensuse.org/?p=5480#Credits)


  * [ Translations](https://news.opensuse.org/?p=5480#Translations)
...
####  [openSUSE News: openSUSE Announces Third Development Milestone Evaluating systemd](https://news.opensuse.org/2010/11/11/opensuse-11-4m3/)
...
####  [openSUSE Forum has New News Editor](https://news.opensuse.org/2010/11/09/opensuse-forum-has-new-news-editor/)
...
####  [openSUSE News: openSUSE at Latinoware](https://news.opensuse.org/2010/11/10/opensuse-at-latinoware/)
...
"At Latinoware, a team of openSUSE contributors will come together, not only to promote openSUSE but also to talk with each other about the future plans for the major linux distribution in Brazil. openSUSE has some awesome technology and great people “ both deserve more attention than they get and this is what the openSUSE ambassadors will talk about!  
 ...
 For those interested in educational software on linux, openSUSE ambassador Carlos Alberto dos Santos Ribeiro, one of the central openSUSE people in Brazil will talk about openSUSE Edu Li-f-e. There are two talks by ambassador Rogerio Ferreira: Xen for Dummies (about visualization on linux) and Automatizando Tarefas ao Extremo com Shell e Expect. Conference co-organizer and all-round cool girl Izabel Cerqueira Valverde will talk about GNOME Women & openSUSE Women “ Mulheres e seus espaÃ§os. Her brother, Ricardo Cerqueira Valverde will discuss openSUSE apresenta Realidade Aumentada em Linux. Silvio Palmieri talks about LaboratÃ³rio de A a Z. And the openSUSE buildservice is covered by Alexandre Duarte Rogoski in openSUSE BuildService “ Construindo Softwares para Diversas Plataformas e DistribuiÃ§Ãµes  
...
####  [OBS 2.1.2 released](http://lists.opensuse.org/opensuse-buildservice/2010-11/msg00130.html)
...
"It has been some time since I wrote for the News. During the period between the release of 11.3 and the start of Milestone releases for 11.4, the Testing Core Team was essentially inactive - at least as a group. When M3 was released, I was away from home and missed an IRC meeting. From the transcript, I learned that the Xorg crashes made the system essentially unusable. That bug also delayed the release of M3 for almost a week, but it is now available.  
 ...
 See [http://en.opensuse.org/openSUSE:Testing_meeting](http://en.opensuse.org/openSUSE:Testing_meeting) for details. Anyone that wishes may join us.  
...
Past: 
  ...
  * [**November 10, 2010: German Wiki Team Meeting**](https://news.opensuse.org/2010/05/30/german-wiki-team-meeting-2/)


  * [**November 11, 2010: ï»¿openSUSE KDE Team meeting**](https://news.opensuse.org/2010/05/13/%ef%bb%bfopensuse-kde-team-meeting/)
  ...
  * [**November 13-14, 2010: OpenRheinRuhr (Oberhausen Germany)**](https://news.opensuse.org/2010/04/19/openrheinruhr-oberhausen-germany/)
...
####  [Michal HrušeckÃ½: MariaDB 5.2.3 in openSUSE (Build Service)](http://michal.hrusecky.net/index.php/blog/show/MariaDB-5.2.3-in-openSUSE-%28Build-Service%29.html)
...
<td style="margin: 0pt 1em 0pt 0pt;" >Do you have comments on any of the things mentioned in this article? Then head right over to the [comment section](https://news.opensuse.org/?p=5480) and let us know!  
...
Delayed / to be translated: 
  ...
  * [æ—¥æ¬èªž](http://ja.opensuse.org/OpenSUSE_Weekly_News/149)
