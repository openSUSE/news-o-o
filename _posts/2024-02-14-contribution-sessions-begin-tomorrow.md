...
The sessions are listed on the [openSUSE Calendar](https://calendar.opensuse.org/) so look for Contribution Workshop sessions marked in orange. 

Those who are interested are interested in presenting should [fill in the blanks for future episodes](https://lists.opensuse.org/archives/list/project@lists.opensuse.org/thread/JKPBGSLO3ZGKSBZMDV7LCYS7JCOVTY4S/). Doing this is a great way to give back to the community and gives opportunities to teach others skills and knowledge about open-source development.
