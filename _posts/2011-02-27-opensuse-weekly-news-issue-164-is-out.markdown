...
Figure 1. Initial screen. "My Projects" are shown in the top-left listview.
...
Figure 2. Double-clicking a project from the list, will list the packages in the project in
...
Figure 3. Double-clicking a package from the top-right listview, will popup a Repository
chooser dialog.
...
Figure 4. The entire buildlog of the selected package is shown in the textarea.
...
This convenience allows us to ship services disabled by default. So installation of
...
**This Article is: Copyright © 2011 Heise Media UK Ltd. The openSUSE
...
**© 2001 - 2011 Softpedia. All rights
reserved.**
...
Look no further! We have the solution right here, and it is easier than you think. Even
...
A lot of cool stuff is happening around ownCloud at the moment. François is working on
...
solutions. Try it here if you don´t have your own server. [https://www.packagecloud.com/?au=owncloud
...
One feature that is also a little bit important is to make it distribution independent to
