...
**[Bretzn results released into the wild](https://news.opensuse.org/2011/02/01/bretzn-results-released-into-the-wild/)**
...
![]({{ site.baseurl }}/assets/bretzn-shots3-300x167.png)
...
Until now these technologies and tools made up mostly isolated islands and it seemed an
      ...
      was first publicly [announced by Frank Karlitschek](https://news.opensuse.org/2010/10/26/from-the-developer-to-the-user-and-back-announcing-project-bretzn/) at the openSuse Conference in Nuremberg in late
...
![The openSUSE application manager]({{ site.baseurl }}/assets/appstore_details-300x207.png)
...
Project Bretzn, then, is not a single piece of software, but rather an attempt to fill in
  ...
  * A thin client in the shape of a Qt Creator plugin, accessed through the Tools menu
            ...
            prompted amending the [Attica](http://api.kde.org/kdesupport-api/kdesupport-apidocs/attica-git/html/) library with new features. As some will already know, Attica FigureÂ 1, The openSUSE application manageris a full featured implementation of a OCS client library
...
**FigureÂ 2.Â Ubuntu Software Centre (from wikipedia)**

![Ubuntu Software Centre (from wikipedia)]({{ site.baseurl }}/assets/Screenshot-Ubuntu_Software_Centre-300x205.png)

  


Moreover, work on a KDE client to download and install applications has started at the
      recent [openSUSE Bretzn sprint in Nuremberg](https://news.opensuse.org/2011/01/27/first-bretzn-sprint-opensuse-app-store-on-the-horizon/). The screenshot in this article shows a first
      prototype. And at the [Cross-distribution meeting on an application installer](https://news.opensuse.org/2011/01/26/app-installer-meeting-or-more-collaboration-accross-borders/), just before the Bretzn
      sprint was held, it was decided the GNOME desktop will receive a client most likely based on
      Ubuntu™s Software center. FigureÂ 1, The openSUSE application manager
...
The project is a collaboration between [h i v e 01](http://hive01.com/),
      ...
      the [Cross-distribution meeting on an application installer](https://news.opensuse.org/2011/01/26/app-installer-meeting-or-more-collaboration-accross-borders/).
...
**[New SSL
        Certificates](https://news.opensuse.org/2011/02/04/new-ssl-certificates/)**
...
![LiveView Device](http://stick.gk2.sk/blog/wp-content/uploads/2011/01/se-liveview-150x150.jpg)

  


Last week we had a Hackweek at Novell. I decided to do something rather unusual for me “
      to hack a device. I bought one of these nifty [LiveView](http://www.sonyericsson.com/cws/products/accessories/overview/liveview) FigureÂ 3, LiveView Device devices made by Sony Ericsson, which are basically an intelligent watch
...
**Upcoming**
  ...
  * [February 10, 2011 : ï»¿openSUSE KDE Team meeting](https://news.opensuse.org/2010/05/13/%ef%bb%bfopensuse-kde-team-meeting/)
...
![](http://stick.gk2.sk/blog/wp-content/uploads/2011/01/ggj11-nuclear-crisis-logo-150x150.png)
...
<table cellpadding="0" cellspacing="0" border="0" width="20%" summary="manufactured viewport for HTML img" ><tr >
<td >![](http://stick.gk2.sk/blog/wp-content/uploads/2011/02/179638_194546517237518_162802187078618_726903_3532401_n-150x150.jpg)
</td></tr></table>
...
Do you have comments on any of the things mentioned in this article? Then head right over to
    the [comment section](https://news.opensuse.org/?p=6537) and let us know! 
...
openSUSE Weekly News is translated into many languages. Issue
  ...
  * [English](https://news.opensuse.org/?p=6537)
