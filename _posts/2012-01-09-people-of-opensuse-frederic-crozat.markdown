...
I've been interested in computer since I was a kid (first computer was a MSX Canon V20).. First žbig program (on a PC 8086 with 10MB hard disk IIRC) I wrote was a billing program for my mom (she owns a bookstore), when I was in 7th grade (first in Quick Basic), then I rewrote it in Turbo Pascal when I learned Pascal in 2nd grade and later, I even rewrote it in Object Oriented Pascal (because I bought Borland Pascal 6 or 7, shipped with huge printed user manual, included OO stuff) when I was in collegue. And my mom used this program (on the same computer) until she closed her shop, 7 years ago ;)
...
I also learned Unix there and discovered Linux because our C teacher told us žyou'll get a free C compiler you'll be able to use at home and then, I became hooked (it was in 1996)
...
I want openSUSE to be the best Linux distribution in the ecosystem, best in the žeasy to use sense, but also best in its interaction with upstream projects.
...
Easy (ie transparent) backup, and getting my data synchronized and available everywhere ( I know both those ideas are being addressed, but not yet fully and in a žeasy for my mom to use form)
...
Understand assembly language and this kind of low level stuff. I learned it at school, but it was never my žthing


#### The Internet crashes for a whole week ” how would you feel, what would you do?


This is exactly what I'm experiencing right now (moving between flats). So, I'm using a 3G Internet access at home... More seriously, in the past, when I was travelling for my holidays, I always make sure to žunplug myself for one or two weeks and everything went fine.
...
Heavy Rain / ICO. When I was younger, the various žCommander Keen from Apogee Software
