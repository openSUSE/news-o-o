...
[openSUSE 11.4 Will Be First To Roll Out With LibreOffice](https://news.opensuse.org/2011/03/07/opensuse-11-4-will-be-first-to-roll-out-with-libreoffice/)
...
![]({{ site.baseurl }}/assets/LibreOffice-splash-150x150.jpg)
...
![]({{ site.baseurl }}/assets/11.4-screenshot-libreoffice-calc-on-xfce-300x225.jpg)
...
![]({{ site.baseurl }}/assets/libreoffice-300x187.png)
...
![]({{ site.baseurl }}/assets/11.4-screenshot-libreoffice-writer-on-lxde-300x225.jpg)
...
![]({{ site.baseurl }}/assets/11.4-screenshot-libreoffice-start-300x225.jpg)
...
[Live.Code.Party.](https://news.opensuse.org/2011/03/07/live-code-party/)
...
![]({{ site.baseurl }}/assets/the-party-150x150.jpg)

In the land of the free, Lizards will meet in San Diego, Americas finest city. The [Kernel-Panic Linux User Group (KPLUG)](http://www.kernel-panic.org/) kindly
...
![]({{ site.baseurl }}/assets/frets_on_fire-300x240.jpg)
...
openSUSE Ambassadors Fernando MejÃ­a, founder of the [openSUSE LUG Guatemala](http://www.opensuse.org.gt/) and Axel Ruiz will host a
      party in the beautiful Centro HistÃ³rico, Ciudad de Guatemala. It™s going to take place in a
...
![]({{ site.baseurl }}/assets/party_map-e1299503361641-300x147.png)

By the way if you™re interested in hosting your own launch party, see our [Launch Party HOWTO](http://en.opensuse.org/openSUSE:Launch_party_HOWTO) for
...
[openSUSE News: openSUSE 11.4 “ A New Hallmark For The openSUSE Project](https://news.opensuse.org/2011/03/10/opensuse-11-4/)
...
We are proud to announce the launch of 11.4 in the openSUSE tradition of delivering the
      ...
      [![]({{ site.baseurl }}/assets/get.jpg)](http://software.opensuse.org)
...
<td >![]({{ site.baseurl }}/assets/11.4_NET_installer-boot-150x150.png)
</td></tr></table>
...
<table cellpadding="0" cellspacing="0" border="0" width="40%" summary="manufactured viewport for HTML img" ><tr >
<td >![]({{ site.baseurl }}/assets/Startup-150x150.png)
</td></tr></table>
...
<table cellpadding="0" cellspacing="0" border="0" width="40%" summary="manufactured viewport for HTML img" ><tr >
<td >![]({{ site.baseurl }}/assets/11.4_DVD_installer-overview1-e1299760821406.png)
</td></tr></table>
...
The [ZYpp](http://en.opensuse.org/Portal:Libzypp) package management
...
<table cellpadding="0" cellspacing="0" border="0" width="40%" summary="manufactured viewport for HTML img" ><tr >
<td >![]({{ site.baseurl }}/assets/114_screenshots_gnome_pulse_speaker_tests-e1299761291203-150x150.jpg)
</td></tr></table>
...
openSUSE offers deep integration of all these technologies. By carefully creating
...
<table cellpadding="0" cellspacing="0" border="0" width="40%" summary="manufactured viewport for HTML img" ><tr >
<td >![]({{ site.baseurl }}/assets/11.4-VirtualBox-150x150.png)
</td></tr></table>
...
<table cellpadding="0" cellspacing="0" border="0" width="40%" summary="manufactured viewport for HTML img" ><tr >
<td >![]({{ site.baseurl }}/assets/11.4-YaST-HTTP-Module-e1299762428373-150x150.png)
</td></tr></table>
...
<table cellpadding="0" cellspacing="0" border="0" width="40%" summary="manufactured viewport for HTML img" ><tr >
<td >![]({{ site.baseurl }}/assets/11.4-KDevelop-150x150.png)
</td></tr></table>
...
openSUSE 11.4 comes with **all the major development languages,
...
<table cellpadding="0" cellspacing="0" border="0" width="40%" summary="manufactured viewport for HTML img" ><tr >
<td >![]({{ site.baseurl }}/assets/appstream.png)
</td></tr></table>
...
<table cellpadding="0" cellspacing="0" border="0" width="40%" summary="manufactured viewport for HTML img" ><tr >
<td >![]({{ site.baseurl }}/assets/11.4-studio-150x150.jpg)
</td></tr></table>
...
<table cellpadding="0" cellspacing="0" border="0" width="40%" summary="manufactured viewport for HTML img" ><tr >
<td >![]({{ site.baseurl }}/assets/11.4-Build-Service-150x150.jpg)
</td></tr></table>
...
The Free and Open Source software developers are greatly aided in the distribution of
...
[openSUSE 11.4 made a splash](https://news.opensuse.org/2011/03/12/opensuse-11-4-made-a-splash/)
...
![Party time on second life for openSUSE 11.4]({{ site.baseurl }}/assets/party-time-on-second-life-300x188.jpg)
...
While openSUSE has been released less than 36 hours ago, a large [number of reviews and articles](http://en.opensuse.org/In_the_press) has already
      appeared and many journalists and writers have commented on the new features. Over at [linuxplanet.com](http://www.linuxplanet.com/) Sean Michael Kerner [talks about tumbleweed and some
        other cool stuff in 11.4](http://www.linuxplanet.com/linuxplanet/newss/7316/1/), quoting Novell™s openSUSE community manager Jos
...
It™s not only an option for early adopters, and we see a preference for these kinds
...
The [announcement on Slashdot](http://linux.slashdot.org/story/11/03/10/2210209/OpenSUSE-114-Released) attracted the usual comments and so did [digg](http://digg.com/news/technology/opensuse_11_4_release). On [Twitter](http://twitter.com/#!/search/opensuse) and [identi.ca](http://identi.ca/search/notice?q=%23opensuse&search=Search)
      ...
      least, the [Facebook
        page](http://www.facebook.com/#!/pages/openSUSE/45393742283) of openSUSE got quite some attention! For all these media: if you™re not a fan,
...
But the above is all talk (and party). What counts are the numbers “ and they are big. To
      just talk about the number of downloads via [software.opensuse.org](http://software.opensuse.org/114/en) we™ve almost doubled the numbers of downloads in the first 24
      hours compared to our [previous 11.3
        release](https://news.opensuse.org/2010/07/16/opensuse-11-3-launch-information/)! Well over 90.000 downloads from our website with another 12 thousand via
...
Since each mirror site uses different ways of measuring, we cannot give an 100% reliable
      ...
      from our more than 80 mirrors. The [Hungary mirror at Integrity.hu](https://news.opensuse.org/2011/03/12/opensuse-11-4-made-a-splash/roxen.integrity.hu) reported 220 GB distributed using http and
      additionally 400 GB via torrents. The [American mirror at temple.edu](https://news.opensuse.org/2011/03/12/opensuse-11-4-made-a-splash/mirror.cst.temple.edu) had 460 GB on Thursday. The [Swiss
        switch.ch](https://news.opensuse.org/2011/03/12/opensuse-11-4-made-a-splash/mirror.switch.ch) distributed 1329 GB of data and the [German
        mirrors from rwth-aachen](https://news.opensuse.org/2011/03/12/opensuse-11-4-made-a-splash/rwth-aachen.de) distributed at peak time 5 gbit/sec and additionally 60
      MB/sec of torrent data.

[SUSE Studio](http://susestudio.com/) offers another great way of
...
However, you™ll be able to find openSUSE 11.4 statistics soon on the [Statistics](http://en.opensuse.org/Statistics) page. There we track how many
...
The openSUSE launch on Thursday was possible thanks to a world wide infrastructure of ftp
      ...
      team and anyone who helped for their awesome work (check out the [Product Highlights](http://en.opensuse.org/Product_highlights) if you haven™t
...
11.4 will be exciting. I mean really, really exciting! There is a huge number of new features and improvements. I just finished an [11.4 feature overview](http://en.opensuse.org/openSUSE:Presentations#openSUSE_11.4) presentation. It's not perfectly complete (how could it be with so much new stuff?) but a good start if you want to have a [launch party](https://news.opensuse.org/2011/03/07/live-code-party/). Speaking of, if you're Dutch, there will be a [Launch Party in NL](http://nl.opensuse.org/openSUSE:Launch_party_11.4)!
...
And remember ” as always, if you have a suggestion for us or encounter a problem, you can let us know on our [forum](http://susestudio.com/forum/) (or our [mailing list](mailto:studio-users@suse.de), which is just another view of the forum). 
...
FigureÂ 4.Â Testdriving openSUSE 11.4's GNOME 2.32 desktop
...
I™ve have to say that the first impressions I had from GNOME Shell from Fedora 13 raised in me a high level of skepticism towards the new interface of GNOME Shell. The contents of this text are mainly influenced by my own view of the things¦ I don™t mean to be disruptive¦ but some things need to be said¦
  ...
  9. Artwork “ My heart is broken (probably my cÃ³ccix as well, I™ve felt from the chair).
...
[Update to GRUB v2 (Score: 103)](https://features.opensuse.org/308497)
...
[i18n of demo dvd](https://features.opensuse.org/311477)
...
Past
  ...
  * [March 09, 2011 : Project Meeting](https://news.opensuse.org/2010/02/09/opensuse-project-meetings/)

Upcoming

  * [March 23, 2011 : Project Meeting](https://news.opensuse.org/2010/02/09/opensuse-project-meetings/)
...
[SUSE Security Announcement: acroread (SUSE-SA:2011:011)](http://lists.opensuse.org/opensuse-security-announce/2011-03/msg00000.html)
...
The core of these developments is that different storage protocols can now be called as SCSI targets through the iSCSI, the Fibre Channel™s Fibre Channel over Ethernet. The [linux-isci.org](http://www.linux-iscsi.org/wiki/Features) features will in future supersede the existing SCSI subset. That is the SANs will no longer be on STGT, the SCSI Target Framework, or the CONFIG_SCSI_TGT on the kernel configuration.
...
On Tuesday last week, Linus Torvalds [issued](http://thread.gmane.org/gmane.linux.kernel/1107280) the seventh release candidate of Linux 2.6.38. Among other things, Torvalds mentioned a fix for a flaw in Btrfs that can potentially cause data loss in certain situations “ again, there was no indication of a final release date for 2.6.38.
...
[Rares Aioanei: kernel weekly news “12.03.2011](http://schaiba.wordpress.com/2011/03/12/kernel-weekly-news-12-03-2011/)
...
[Martin Grässlin: Proactive Spam Fighting with Akonadi](http://blog.martin-graesslin.com/blog/2011/03/proactive-spam-fighting-with-akonadi/)
...
If you're really anxious to try out GNOME 3 and GNOME Shell, there's a [live USB flash drive image](http://blog.crozat.net/2011/01/gnome-3-live-cd-usb-test-image.html) around here somewhere, that you can boot your machine, or a virtual machine from and "try before you buy."
...
![](http://cdn.omgsuse.com/omg/images/snapshot22-300x187.png)
...
To be honest, I've had a hard time summarizing what's special about KDE in openSUSE 11.4 versus KDE in 11.3, any way you cut it I'm out of my comfort zone (there is a write-up on [news.opensuse.org](https://news.opensuse.org/2011/03/02/opensuse-11-4-and-kde-2/) though). I will say this though: KDE 4.6 in the new openSUSE is visually **stunning** and **fast**. THe KDE team has done a phenomenal job speeding up KDE and bucking the trend of software getting slower over time.
...
This week has been a busy week : GNOME people worked really hard on 2.91.91 release and openSUSE people worked really hard on release [openSUSE 11.4](https://news.opensuse.org/2011/03/10/opensuse-11-4/).
...
## ![Header Picture](http://saigkill.homelinux.net/pub/OWN/common/logos/OWN-oxygen-openSUSE-Forums.png)openSUSE Forums - We celebrate the release of 11.4



[openSUSE 11.4 “ A New Hallmark For The openSUSE Project](http://forums.opensuse.org/english/other-forums/news-announcements/tech-news/455278-opensuse-11-4-new-hallmark-opensuse-project.html)
...
[NEW Users - openSUSE-11.4 Pre-installation “ PLEASE READ](http://forums.opensuse.org/english/get-technical-help-here/how-faq-forums/new-user-how-faq-read-only/454963-new-users-opensuse-11-4-pre-installation-please-read.html)
...
[Datamation/Matt Hartley: 15 Must-Have Linux Desktop Apps](http://itmanagement.earthweb.com/osrc/article.php/3927256)
...
A bug in the Caiaq USB driver, which could be used to execute arbitrary at the kernel level has been [reported by](http://labs.mwrinfosecurity.com/files/Advisories/mwri_caiaq-usb-drivers-buffer-overflow_2011-03-07.pdf) Rafael Dominguez Vega of MRW InfoSecurity.

The device drivers are vulnerable to [buffer overflow](http://en.wikipedia.org/wiki/Buffer_overflow) condition when an USB device with an unusually long name (over 80 characters) is connected to the machine. This is due to the use of strcpy() which length is not being tested, enabling the attacker to execute malicious code on the target machine. (...)
...
Do you have comments on any of the things mentioned in this article? Then head right over to
    the [comment section](https://news.opensuse.org/?p=7491) and let us know! 
