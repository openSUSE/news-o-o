...

      ...
      [Have a computer? Then you can participate in the HCL Week!](https://news.opensuse.org/2011/07/08/have-a-computer-then-you-can-participate-in-the-hcl-week/)
...
Since I really like this change in focus for this year's conference, I decided that I would not submit a talk, but only [BoFs](https://news.opensuse.org/2011/06/14/opensuse-conference-and-rw-sessions-the-bof/) and [workshops](http://en.opensuse.org/openSUSE:Conference_Planning_2011_guidelines_for_speakers#Workshop).
...
### People of openSUSE
        ...
        [People of openSUSE: Manu Gupta](https://news.opensuse.org/2011/07/05/people-of-opensuse-manu-gupta/)
...

      ...
      [Nelson Marques: The Â«BansheeÂ» incident¦](http://www.marques.so/2011/07/the-%C2%ABbanshee%C2%BB-incident-a-horror-tale-by-nmarques/)
...
openSUSE Weekly News is translated into many languages. Issue 183 is available in: 
  ...
  * [English](https://news.opensuse.org/?p=9544)
