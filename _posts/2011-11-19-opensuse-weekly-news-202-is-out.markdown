...
### Community Articles
        ...
        [openSUSE 12.1: All Green!](https://news.opensuse.org/2011/11/16/opensuse-12-1-all-green/)
...
![]({{ site.baseurl }}/assets/12.1_Installer-boot1-300x225.png)
...
[Join or organize openSUSE 12.1 Launch parties!](https://news.opensuse.org/2011/11/15/join-or-organize-opensuse-12-1-launch-parties/)
...
[Almost openSUSE
        12.1](https://news.opensuse.org/2011/11/15/almost-opensuse-12-1/)
...
[openSUSE participates in Google Code-in](https://news.opensuse.org/2011/11/18/opensuse-participates-in-google-code-in/)
...
openSUSE 12.1 is [officially released today](https://news.opensuse.org/2011/11/16/opensuse-12-1-all-green/). This is a major milestone both for its users and developers, mainly because
...
I guess it™s time for another [Evergreen](http://en.opensuse.org/openSUSE:Evergreen) status update.
...

      ...
      [Rares
        Aioanei: kernel weekly news “ 19.11.2011](http://schaiba.wordpress.com/2011/11/19/kernel-weekly-news-19-11-2011/)
...
![](http://4.bp.blogspot.com/-wcHIM8JzaeI/TsCNhUw6VyI/AAAAAAAAAKY/ZmmWUIKDcVs/s640/whereisverizon.png)
...
![](http://saigkill.homelinux.net/images/preferences-activities.png)
...

      ...
      [Jörg Stephan: The Packman Repo (cause of sox)](http://suseserver.de/?p=56)
...

    ...
    [Forums: Install - Boot - Login](http://forums.opensuse.org/english/get-technical-help-here/install-boot-login/)
      ...
      [Help me fix my repos before the update day](http://forums.opensuse.org/english/get-technical-help-here/install-boot-login/467703-help-me-fix-my-repos-before-update-day.html)
...
![](http://www.h-online.com/imgs/43/7/3/6/3/1/3/Balsam_logo-6736b098b491125d.png)
...

        ...
        [Webappers/Ray Cheung: Open Source WYSIWYG Visual Editor for UI Mockups](http://www.webappers.com/2011/11/15/open-source-wysiwyg-visual-editor-for-ui-mockups/)
...
I have been administrating Linux systems for a while now and were always strugling to ždig deeper. Today I found myself wondering how does Linux detect, plug in my hardware and show that pop-up window asking me to choose what I want to do with my flash drive. So I launched my web browser and began to search for an answers in forums, tutorials and how-tos which almost ended in complete failure. I say žalmost because I did find some of the answers but they all were scattered and incomplete or too old. So I had to use žheavy artillery and read through all those manuals¦ And I think I finally get it how it works :) This is what I will try to explain further. *I really hope I didn™t misunderstand something* (...)
...
openSUSE Weekly News is translated into many languages. Issue 202 is available in: 
  ...
  * [English](https://news.opensuse.org/?p=11777)
