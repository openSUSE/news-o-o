...
[Get your fresh kernels from openSUSE and test Linux 3.0!](https://news.opensuse.org/2011/06/06/get-your-fresh-kernels-from-opensuse-and-test-linux-3-0/)
...
![openSUSE kernel commit activity overview]({{ site.baseurl }}/assets/kernel-activity-300x120.png)
...
If you want to get the source code of the kernel branch, or browse its git tree, click on
      ...
      who in the FigureÂ 1, openSUSE kernel commit activity overviewGIT Browse page. For example, [this link](http://kernel.opensuse.org/cgit/kernel/log/?h=master) brings you to a
...
[Time to vote on the openSUSE Strategy!](https://news.opensuse.org/2011/06/07/time-to-vote-on-the-opensuse-strategy/)
...
We™re not asking everyone if they think it is a perfect fit for themselves “ we™re a
      diverse community and we™ll never fully agree on anything. But this proposal has seen lots of
        [thought](http://en.opensuse.org/Portal:Strategy), [discussion](http://lwn.net/Articles/392467/), [revision](https://lite.co-ment.com/text/lNPCgzeGHdV/view/), [input](https://news.opensuse.org/2010/10/07/opensuse-strategy-the-third-and-fourth-part-of-the-trilogy/) “ it is arguably the best we could come up with to describe who we are and
...
[openSUSE
        conference looking for sponsors](https://news.opensuse.org/2011/06/08/opensuse-conference-looking-for-sponsors/)
...
![]({{ site.baseurl }}/assets/RWX3-300x127.png)
...
In 2011, the theme of the combined openSUSE and SUSE Labs Conference is [RWX, the UNIX acronym for Read-Write-Execute](https://news.opensuse.org/2011/05/16/opensuse-conference-2011-to-be-creative-and-open/). To bring this theme to life, the
...
![]({{ site.baseurl }}/assets/Zentr_impress-300x148.jpg)
...
[World IPv6 Day
        Results](https://news.opensuse.org/2011/06/09/world-ipv6-day-results/)

Yesterday was World IPv6 Day and openSUSE [participated](https://news.opensuse.org/2011/05/31/opensuse-and-world-ipv6-day/)
...
Here is a short status update from the openSUSE infrastructure. openSUSE has currently two
      ...
      openSUSE infrastructure locations, including the server which runs the popular [planet.opensuse.org](https://news.opensuse.org/2011/06/09/planet.opensuse.org)
...
[New
        Leadership inside the Medical Project](https://news.opensuse.org/2011/06/09/new-leadership-inside-the-medical-project/)
...
In this post, I would like to discuss some ideas I™ve had on improving the project /
      package view pages in the OBS mobile client, and seek users™ feedback. (Please alsoÂ [take a
...
Awesomeness!!! Yup - we've got a strategy proposal under vote. Sorry it took so long.
        Everyone, both from the board and the strategy team, has been busy with the [openSUSE 11.4](https://news.opensuse.org/2011/03/10/opensuse-11-4/) release and
        the [upcoming openSUSE conference](https://news.opensuse.org/2011/05/16/opensuse-conference-2011-to-be-creative-and-open/). But the board has asked Thomas Thym to get it out 2
...
On the green "I want you" picture on [news.opensuse.org](https://news.opensuse.org): I got it off the web and used [Krita](http://krita.org/) to make it green. I know, Krita is meant as an artist tool, a painting app.
...
The image in the previous [Milestone 1](https://news.opensuse.org/2011/06/01/first-step-towards-12-1-with-milestone-1/) article WAS made with the right tool: Krita again. Just 5 minutes
...
With the long summer nights ahead I™ve decided to enable my subscription of World of
      ...
      best days as a player during The Burning Crusade¦ the Wrath of the Lich KingÃ½expansionÃ½sucked
      and I like to dub it as a ˜beggarsÃ½expansion™¦ where casuals could have some fancy epic gear
...
In aÂ [former article](http://www.linuxaria.com/article/skype-to-microsoft-its-time-to-know-xmppjingle?lang=en)Â I™ve talked about the XMPP:Jingle protocol to find a good
...
In particular I™ll show you: ï»¿pgrep, ï»¿grepcidr, ngrep, pdfgrep and ï»¿taggrepper.
...
![](http://stick.gk2.sk/blog/wp-content/uploads/2011/06/ps1tricks-300x125.png)
...

      ...
      This is the former landing page of http://forums.opensuse.org. An overview of the international forums, and the language specific subforums -we currently serve Nederlands (Dutch), FranÃ§ais (French), Deutsch (German), Î•Î»Î»Î·Î½Î¹ÎºÏŒ (Greek), Magyar (Hungarian), æ—¥æ¬èªž (Japanese), Portuguese (Portuguese), PÑƒÑÑÐºÐ¸Ð¹ (Russian) under the big openSUSE Forums umbrella, plus links to the ×¢Ö´×‘×¨Ö´×™×ª (Hebrew) and EspaÃ±ol (Spanish) ones. Other languages are under contstruction, awaiting setup etc.
...
openSUSE Weekly News is translated into many languages. Issue 179 is available in: 
  ...
  * [English](https://news.opensuse.org/?p=9132)
