...
In user space Full Disk Encryption (FDE), as opposed to the boot loader based FDE, developers for [openSUSE](https://get.opensuse.org/) supported signed policy and NVIndex policy from the beginning when Trusted Platform Module 2 (TPM2) is used.
...
<meta name="openSUSE, Open Source, development, Linux, secure operating systems, open source, full disk encryption, MicroOS, Tumbleweed" content="HTML,CSS,XML,JavaScript">
