...
title: Closes Out the Leap 15 Era
categories:
- Announcements
- openSUSE
- Leap
...
You can download openSUSE Leap 16 and use the [migration tool to upgrade](https://news.opensuse.org/2025/10/01/migrating-to-leap-16-with-opensuse-migration-tool/).
