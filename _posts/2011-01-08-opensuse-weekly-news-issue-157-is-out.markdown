...
**
      [openSUSE finished
        2010 big](https://news.opensuse.org/2011/01/03/opensuse-finished-2010-big/)
    **
...
<td align="center" >![By somenametoforget at Flickr]({{ site.baseurl }}/assets/somenametoforget3-e1293654145463-300x200.jpg)
</td></tr></table>
...
<table cellpadding="0" cellspacing="0" border="0" width="50%" summary="manufactured viewport for HTML img" ><tr >
<td align="center" >![By mr.Mac2009 on Flickr]({{ site.baseurl }}/assets/4145944314_e12040f6cf_z-300x225.jpg)
</td></tr></table>
...
<table cellpadding="0" cellspacing="0" border="0" width="50%" summary="manufactured viewport for HTML img" ><tr >
<td align="center" >![by misterfreak on Flickr]({{ site.baseurl }}/assets/3065448236_fcf08f7c69_z-300x207.jpg)
</td></tr></table>
...
<table cellpadding="0" cellspacing="0" border="0" width="50%" summary="manufactured viewport for HTML img" ><tr >
<td align="center" >![Integration with Banshee]({{ site.baseurl }}/assets/Ayatana-Screenshot-3-300x207.png)
</td></tr></table>
...
<table cellpadding="0" cellspacing="0" border="0" width="50%" summary="manufactured viewport for HTML img" ><tr >
<td align="center" >![The communication indicator]({{ site.baseurl }}/assets/Ayatana-Screenshot-2-300x205.png)
</td></tr></table>
...
There seems to be a breath of fresh air going through openSUSE. New projects are started,
      recently started projects seem to be humming along quite nicely ([project Bretzn](https://news.opensuse.org/2010/10/26/from-the-developer-to-the-user-and-back-announcing-project-bretzn/), for example, is heading for a developer meeting at the SUSE offices
...
**[Putting our Accessibility Heads Together](https://news.opensuse.org/2011/01/06/putting-our-accessibility-heads-together-2/)**
...
### ![Header Picture]({{ site.baseurl }}/assets/Built-with-web-big.png)SUSE Studio
...
#### ![Header Picture]({{ site.baseurl }}/assets/Start-here-branding.png)Marketing Team
...
**Upcoming**
  ...
  * [January
            12, 2011 : openSUSE Project Meeting (16:00)](https://news.opensuse.org/2010/02/09/opensuse-project-meetings/)

  * [January 12,
            2011 : ï»¿openSUSE Board Meeting (19:00)](https://news.opensuse.org/2010/03/24/opensuse-board-meeting/)

  * [January 13, 2011 : ï»¿openSUSE KDE Team meeting (18:00)](https://news.opensuse.org/2010/05/13/%ef%bb%bfopensuse-kde-team-meeting/)
...
And then we have all tools FigureÂ 7, An example graph of network throughput, created with rrdtool by using rrddriver. being able to run over a unix domain socket, including
...
To change the monitor profile one can use kolor-manager FigureÂ 8, kolor-manager device profile selection from
...
Thanks to some great work by the LibreOffice hackers associated with the openSUSE FigureÂ 9, LibreOffice on 11.3 project, LibreOffice is packaged and ready for you to enjoy on
      openSUSE 11.3.
...
Of the top FigureÂ 10, Server Surveyweb servers in current use, Microsoft™s web
...
Do you have comments on any of the things mentioned in this article? Then head right over to
    the [comment section](https://news.opensuse.org/?p=6512) and let us know! 
...
openSUSE Weekly News is translated into many languages. Issue
  ...
  * [English](https://news.opensuse.org/?p=6512)
