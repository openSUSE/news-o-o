...
## ![Header Picture](http://saigkill.homelinux.net/images/Marketing.png)Announcementsâ–¼
      ...
      [ openSUSE Announces First Public Release of openQA](https://news.opensuse.org/2011/10/11/opensuse-announces-first-public-release-of-openqa/)
...
[ Interview about
        openQA](https://news.opensuse.org/2011/10/14/interview-about-openqa/)

Last week, [openQA 1.0](https://news.opensuse.org%22%22) was released. We
...
Past
  ...
  * [October 05, 2011 : Project Meeting](https://news.opensuse.org/2010/02/09/opensuse-project-meetings/)

  * [October 13, 2011 : GNOME Team Meeting](https://news.opensuse.org/2011/01/11/gnome-team-meeting-3/)
...
<table frame="void" id="id319530" >TableÂ 1.Â SUSE Security Announcement<tr >
...
[Michal
          HrušeckÃ½: openSUSE @ ASUS Transformer](http://michal.hrusecky.net/2011/10/opensuse-asus-transformer/)
...
[Michal
        HrušeckÃ½: How to contribute in openSUSE Build Service](http://michal.hrusecky.net/2011/10/how-to-contribute-in-opensuse-build-service/)
...
[Michal
        HrušeckÃ½: How to create patches using quilt](http://michal.hrusecky.net/2011/10/how-to-create-patches-using-quilt/)
...
openSUSE Weekly News is translated into many languages. Issue 197 is available in: 
  ...
  * [English](https://news.opensuse.org/?p=11272)
