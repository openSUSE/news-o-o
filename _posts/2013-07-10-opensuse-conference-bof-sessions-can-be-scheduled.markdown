...
comments: true
date: 2013-07-10 13:55:30+00:00
layout: post
link: https://news.opensuse.org/2013/07/10/opensuse-conference-bof-sessions-can-be-scheduled/
slug: opensuse-conference-bof-sessions-can-be-scheduled
title: openSUSE Conference BoF sessions can be scheduled!
wordpress_id: 16320
categories:
- Conference
---

[![oSC 2013 Conf Logo Single](//news.opensuse.org/wp-content/uploads/2013/01/conf_logo.png)](//news.opensuse.org/wp-content/uploads/2013/01/conf_logo.png)
Within two weeks, in thessaloniki, the openSUSE Conference will start off again. Like last year, we have not only an awesome program but also reserved time for small sessions to get work done. We've got a wiki page where you can [schedule such sessions before the event](//en.opensuse.org/openSUSE:Conference_BoF) and on the event itself we'll allow scheduling more sessions Unconference style. Read on to learn more about the [BoF](//en.wikipedia.org/wiki/Birds_of_a_Feather_(computing)) session, based on an article from our famous RW conference in 2011!<!-- more -->


## Definition


Wikipedia [defines](//en.wikipedia.org/wiki/Birds_of_a_Feather_(computing)) a BoF as 'an informal discussion group', 'often formed in an ad-hoc manner'. It also describes a BoF as 'an informal meet-up at conferences, where the attendees group together based on a shared interest and carry out discussions without any pre-planned agenda'.
...
[![Drupalcon 2008 Boston Birds of a Feather board](//farm3.static.flickr.com/2363/2311306708_5a29c44a0b_m.jpg)](//www.flickr.com/photos/fourkitchens/2311306708/)
...
[![Birds of a Feather](//farm1.static.flickr.com/49/171249238_1421d15dca_m.jpg)](//www.flickr.com/photos/shrued/171249238/)
...
[![Drupalcon Tuesday BoF Session](//farm3.static.flickr.com/2797/4537737867_3ebfc19183_m.jpg)](//www.flickr.com/photos/tfdavis/4537737867/)
...
So go to the [BoF wiki page](//en.opensuse.org/openSUSE:Conference_BoF) and add a BoF! You've got until the day before the conference to do this - after that, we'll schedule at the event itself using whiteboards.
