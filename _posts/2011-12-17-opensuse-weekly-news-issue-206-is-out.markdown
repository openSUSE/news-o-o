...
[openSUSE Board Election 2011 results](https://news.opensuse.org/2011/12/17/opensuse-board-election-2011-results/)
...
[
        Forums and Wikis and Blogs, Oh MY!](https://news.opensuse.org/2011/12/12/forums-and-wikis-and-blogs-oh-my/)
...
[FOSDEM12 Cross-Distribution Devroom: (Last) Call for Participation](https://news.opensuse.org/2011/12/16/fosdem12-cross-distribution-devroom-last-call-for-participation/)
...
Today our SUSE Appliance Workshop week ended, so I want to write down a little bit of
        ...
        want to present it to the public (that™s you ![](http://suse.gansert.net/wp-includes/images/smilies/icon_wink.gif) ).
...
Past
  ...
  * [December 12, 2011 : Testing Core Team Meeting](https://news.opensuse.org/2011/01/20/testing-core-team-meeting/)

  * [December 14, 2011 : Project Meeting](https://news.opensuse.org/2010/02/09/opensuse-project-meetings/)

  * [December 15, 2011 : GNOME Team Meeting](https://news.opensuse.org/2011/01/11/gnome-team-meeting-3/)
...

      ...
      [h-online/Thorsten Leemhuis: Kernel Log: Coming in 3.2 (Part 4) “ Infrastructure](http://www.h-online.com/open/features/Kernel-Log-Coming-in-3-2-Part-4-Infrastructure-1395236.html)
...

      ...
      [Rares
        Aioanei: kernel weekly news “ 17.12.2011](http://schaiba.wordpress.com/2011/12/17/kernel-weekly-news-17-12-2011/)
...
Did you know that if you need to scroll suddenly while typing, you don™t need to reach out for your mouse? Just use the Ctrl-â†‘ or the Ctrl-â†“ key combinations to scroll up or down. (...)
...
There has been a lot going on in MySQL community and I didn™t blogged about MySQL for some
      ...
      know what, where and in which version we™ve got in Build Service. And as I recently [dropped server:database:UNSTABLE](http://michal.hrusecky.net/2011/10/serverdatabaseunstable-and-serverdatabase-merge/) repo, everything is now in [server:database](http://download.opensuse.org/repositories/server:/database/),
...
Today finally my new [PandaBoard
  ...
  * provides 25% increase in graphics performance over OMAP4430 (but use a Imagination
            Technologies™ POWERVRâ„¢ SGX540 graphics core as the PandaBoard)
...
I finally found some time the last days to play with my new PandaBoard ES. As first [Dirk Müller](http://lizards.opensuse.org/author/dirkmueller/) helped me by
...
I'll submit a new kernel package, but for now you can get the RPMs [here](http://beta.suse.com/private/dkukawka/pandaboardES/).
...
openSUSE Weekly News is translated into many languages. Issue 206 is available in: 
  ...
  * [English](https://news.opensuse.org/?p=12171)
