...
The third version of the [Oyranos Colour
                Management LiveCD](http://susestudio.com/a/8Kr6tw/oyranos-multimedia-121) is based on [openSUSE-12.1](http://www.opensuse.org) and will run on x86_64 compatible PCýs. I placed the ISO
...
There has been a lot going on in MySQL community and I didn’t blogged about MySQL for some
      time. So this is a small update regarding MySQL in [openSUSE Build Service](http://build.opensuse.org)ýand in openSUSE in general. This post is intended to let you
