...
"It’s been a while since I’ve posted or been active in the community, so I thought I’d toss an update out there. I’ll cross post this on my personal blog and on Cool Solutions (modified for SLEx 10). This is a pretty rudimentary post as installation from source is pretty straightforward, but perhaps it’ll be useful to someone.  The only requirements for this build that I’m aware of at this time are make, gcc, and the openssl/openssl-devel packages.  The default Ruby distribution in 11.2 is 1.8.7, contrasting the current stable release of 1.9.1. If you already have Ruby installed via zypper, you’ll need to uninstall it (’sudo zypper rm ruby’), otherwise the first step is to grab the latest release from ﻿[http://www.ruby-lang.org/en/downloads/](http://www.ruby-lang.org/en/downloads/)."  
...
[English](http://en.opensuse.org/OpenSUSE_Weekly_News/118) [Deutsch](http://de.opensuse.org/OpenSUSE-Wochenschau/118) [Español](http://es.opensuse.org/OpenSUSE_Noticias_Semanales/118) [日本語](http://ja.opensuse.org/OpenSUSE_Weekly_News/118) [Русский](http://ru.opensuse.org/%D0%95%D0%B6%D0%B5%D0%BD%D0%B5%D0%B4%D0%B5%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5_%D0%BD%D0%BE%D0%B2%D0%BE%D1%81%D1%82%D0%B8_openSUSE/118) [Polski](http://pl.opensuse.org/Tygodnik_openSUSE/118) [Português](http://pt.opensuse.org/Not%C3%ADcias_da_semana_no_openSUSE/118) [Indonesia](http://en.opensuse.org/OpenSUSE_Weekly_News/118/indonesian) [Magyar](http://hu.opensuse.org/OpenSUSE_Heti_H%C3%ADrmond%C3%B3/118) [Italiano](http://it.opensuse.org/OpenSUSE_Newsletter_Settimanale/118) [简体中文](http://en.opensuse.org/OpenSUSE_Weekly_News/118/chinese) [繁體中文](http://zh_tw.opensuse.org/OpenSUSE_Weekly_News/118) [Français](http://fr.opensuse.org/Lettre_d%27information_openSUSE/118) [Svenska](http://en.opensuse.org/OpenSUSE_Weekly_News/118/swedish) [Íeština](http://cs.opensuse.org/OpenSUSE_t%C3%BDden%C3%ADk/118)
</td>
</tr>
</tbody>
</table>
