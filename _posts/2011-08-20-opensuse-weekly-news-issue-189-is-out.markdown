...
Last year, the conference had the motto [‘Collaboration Across Borders’](http://news.opensuse.org/2011/08/15/?p=5223) and
...
**Find more information about the location, how to get there and where
...
[Michal
        Hrušecký: openSUSE Conference 2011 – SaX3](http://michal.hrusecky.net/2011/08/opensuse-conference-2011-sax3/)
...
Manu started working on this project. He had to learn a lot of new things, but he put a
      lot of effort into that and in the end, there is completely new SaX3. It uses [libyui](http://sourceforge.net/projects/libyui/)ýfor GUI toolkits abstraction.
...
Let me summarize the changes that have taken place over the last three months. For
      ...
      Hrušecký even ported the library to Gentoo! – [michal.hrusecky.net/2011/08/libyui-in-gentoo/](http://nbprashanth.wordpress.com/2011/08/18/libyui-ported/michal.hrusecky.net/2011/08/libyui-in-gentoo/). The source has been completely
...
So, I've took now the same route that Fedora did and reenabled the sunrpc code in glibc
